//
//  ArtEditViewController.m
//  NPRender
//
//  Created by Chen Xianshun on 18/5/12.
...
@interface ArtEditViewController ()

@end

@implementation ArtEditViewController
...
-(void) viewWillAppear:(BOOL)animated
{
    ...
    UIImage* srcImage=[UIImage imageWithContentsOfFile:npr.origFullPath];
    
    if(![npr.origFullPath isEqualToString:self.canvas.srcImagePath])
    {
        /*
        ...
        self.canvas.srcImagePath=npr.origFullPath;
        self.canvas.imgBuffer=[UIImage imageWithContentsOfFile:npr.fullPath];
    }
